...
function calcAvgScores() {
    ...
    console.log(`Dolphin Avg score is ${dolphinAvgScore}`)
    console.log(`Koala Avg score is ${koalaAvgScore}`)
}
calcAvgScores();
...
function checkWinner(dolphinAvgScore, koalaAvgScore) {
    ...
    else if ((koalaAvgScore > dolphinAvgScore) && (koalaAvgScore > dolphinAvgScore * 2)) {
